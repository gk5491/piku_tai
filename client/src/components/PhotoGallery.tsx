  ...
  return (
    <section className="py-24 px-4 overflow-hidden relative bg-gradient-to-b from-white to-pink-50/50">
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <h2 className="text-5xl md:text-6xl font-display text-primary mb-4 drop-shadow-sm">
          Our Love Story
        </h2>
        ...
        <div className="relative flex flex-col justify-center items-center">
          <div className="relative w-[300px] h-[300px] md:w-[500px] md:h-[500px] group flex items-center justify-center">
            <svg
              viewBox="0 0 200 200"
